    ...
    <div className="App">
      <header className="App-header" style={{background: `radial-gradient(${color[1]},${color[0]})`,color:color[0]}}>
        <div id="quote-box">
          ...
          <a target = "_black" href={encodeURI(`http://www.twitter.com/intent/tweet?text=${Quote}`)}id="tweet-quote"> <i style={{color:color[0]}} class="fa fa-twitter"></i></a>
          <button id="new-quote" onClick={()=>randomgenerate()} style={{backgroundColor:color[1]}}>Generate</button>
          <p  id="din"style={{color:color[0]}}><a target="_blank" href="https://www.linkedin.com/in/lakshmi-narayana-malineni-9815451ba">by <u >Nani</u></a></p>
        </div>
